						...
						<ul class="nav navbar-nav pull-right">
							...
							<li class="dropdown dropdown-user dropdown-dark">
								<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
									<img alt="" class="img-circle" src="http://mapgeo.id:8822//foto/1564449496262-user.png">
							...
							<li class="menu-dropdown classic-menu-dropdown <?php if($parent=='report'){echo 'active';}else{echo '';} ?>">
								...
								<ul class="dropdown-menu pull-left">
									<li class=" <?php if($child=='infus'){echo 'active';}else{echo '';} ?>">
										<a href="<?php echo site_url('member_side/laporan_infus'); ?>" class="nav-link nav-toggle ">
