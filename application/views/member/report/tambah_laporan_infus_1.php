...
<div class="page-content-inner">
	<div class="m-heading-1 border-yellow m-bordered" style="background-color:#FAD405;">
		...
		<p> 3. Barang yang tercantum adalah barang yang sudah masuk kriteria limit stok.</p>
	</div>
	<div class="row">
		<div class="col-md-12">
			...
			<div class="portlet light ">
				<div class="portlet-body">
					...
					<div class="form-body">
						<form role="form" class="form-horizontal" action="<?=base_url('member_side/tambah_barang_infus');?>" method="post" enctype='multipart/form-data'>
							...
							<div class="form-group form-md-line-input has-danger">
								...
								<div class="col-md-4">
									<div class="input-icon">
										<input type="number" class="form-control" name="qty" placeholder="Type something" required min='1' max='999999'>
						...
						<tbody>
							...
							<tr>
								...
								<td style="text-align: center;">
									<a class="btn btn-xs red" type="button" href='<?=base_url('member_side/hapus_barang_infus/'.$value['rowid']);?>'> Hapus
					...
					<div class="form-actions margin-top-10">
						<div class="row">
							<div class="col-md-offset-2 col-md-10">
								<!-- <a class="btn blue" href='<?=base_url('member_side/tambah_laporan_infus_2/');?>'>Lanjut  <i class='icon-control-play'></i></a> -->
								<a class="btn blue" href='<?=base_url('member_side/simpan_data_laporan_infus/');?>'>Ajukan Permintaan</a>
							</div>
						</div>
					</div>
				</div>
