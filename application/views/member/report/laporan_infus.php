						...
						<div class="row">
							<div class="col-md-8">
								<div class="btn-group">
									...
									<a href="<?=base_url('member_side/tambah_laporan_infus');?>" class="btn green uppercase">Tambah Data <i class="fa fa-plus"></i> </a>
							</div>
						</div>
					</div>
					...
					<script type="text/javascript" language="javascript" >
						$(document).ready(function(){
							$('#tbl').dataTable({
								...
								"ajax" : {
									type:"POST",
									url: "<?php echo site_url('member/Report/json_stok_infus')?>",
									cache: false
								},
								"aoColumns": [
