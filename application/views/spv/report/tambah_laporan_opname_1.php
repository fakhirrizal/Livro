						...
						<tbody>
							...
							<tr>
								...
								<td style="text-align: center;">
									<a class="btn btn-xs red" type="button" href='<?=base_url('spv_side/hapus_barang_opname/'.$value['rowid']);?>'> Hapus
					...
					<div class="form-actions margin-top-10">
						<div class="row">
							<div class="col-md-offset-2 col-md-10">
								<a class="btn blue" href='<?=base_url('spv_side/tambah_laporan_opname_2/');?>'>Lanjut  <i class='icon-control-play'></i></a>
							</div>
						</div>
					</div>
				</div>
