		...
		<div class="col-md-12">
			...
			<div class="portlet light ">
				<div class="portlet-body">
					...
					<div class="form-body">
						<form role="form" class="form-horizontal" action="<?=base_url('spv_side/tambah_barang_infus');?>" method="post"  enctype='multipart/form-data'>
							...
							<div class="form-group form-md-line-input has-danger">
								<label class="col-md-2 control-label" for="form_control_1">Harga Satuan <span class="required"> * </span></label>
								<div class="col-md-4">
									<div class="input-icon">
						...
						<tbody>
							...
							<tr>
								...
								<td style="text-align: center;">
									<a class="btn btn-xs red" type="button" href='<?=base_url('spv_side/hapus_barang_infus/'.$value['rowid']);?>'> Hapus
					...
					<div class="form-actions margin-top-10">
						<div class="row">
							<div class="col-md-offset-2 col-md-10">
								<a class="btn blue" href='<?=base_url('spv_side/tambah_laporan_infus_2/');?>'>Lanjut  <i class='icon-control-play'></i></a>
							</div>
						</div>
					</div>
				</div>
