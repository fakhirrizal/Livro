        ...
        <!-- <div class="page-prefooter">
            <div class="container">
                <div class="row">
                        ...
                        <div class="subscribe-form">
                            <form action="javascript:;">
                                <div class="input-group">
                                    <input type="text" placeholder="contact.gbnku.co.id" class="form-control">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 footer-block" style="text-align: center;">
                        <h2>Contacts</h2>
                        <address class="margin-bottom-40"> Phone: +62 852-4297-0666
                            <br> Email:
                            <a href="mailto:http://helpdesk.kemensos.go.id">http://helpdesk.kemensos.go.id</a>
                        </address>
                    </div>
                </div>
            </div>
        ...
        <div class="page-footer">
            <div class="container"> 2019 &copy; LIVRO Coffee.
            </div>
        </div>
