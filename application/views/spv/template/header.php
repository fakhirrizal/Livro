						...
						<ul class="nav navbar-nav pull-right">
							...
							<li class="dropdown dropdown-user dropdown-dark">
								<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
									<img alt="" class="img-circle" src="https://image.freepik.com/free-vector/businessman-profile-cartoon_18591-58479.jpg">
									<span class="username username-hide-mobile">
										<?php
										$get_data = $this->Main_model->getSelectedData('user_profile a', 'a.*', array('a.user_id'=>$this->session->userdata('id')))->row();
										echo $get_data->fullname;
										?>
									</span>
								</a>
								<ul class="dropdown-menu dropdown-menu-default">
									...
									<li>
										<a href="<?php echo site_url('spv_side/bantuan'); ?>">
					...
					<div class="hor-menu  ">
						<ul class="nav navbar-nav">
							...
							<li class="menu-dropdown classic-menu-dropdown <?php if($parent=='report'){echo 'active';}else{echo '';} ?>">
								...
								<ul class="dropdown-menu pull-left">
									<li class=" <?php if($child=='infus'){echo 'active';}else{echo '';} ?>">
										<a href="<?php echo site_url('spv_side/laporan_infus'); ?>" class="nav-link nav-toggle ">
											<i class="icon-action-redo"></i> Stok Infus
										</a>
									</li>
									<li class=" <?php if($child=='opname'){echo 'active';}else{echo '';} ?>">
										<a href="<?php echo site_url('spv_side/laporan_opname'); ?>" class="nav-link nav-toggle ">
							...
							<li class="menu-dropdown classic-menu-dropdown <?php if($parent=='log_activity'){echo 'active';}else{echo '';} ?>">
								<a href="<?php echo site_url('spv_side/log_activity'); ?>"><i class="fa fa-rss"></i> Log Aktifitas
								</a>
							</li>
						</ul>
					</div>
