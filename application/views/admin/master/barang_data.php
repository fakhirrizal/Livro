						...
						<div class="row">
							<div class="col-md-8">
								<div class="btn-group">
									...
									<a href="<?=base_url('admin_side/tambah_data_barang');?>" class="btn green uppercase">Tambah Data <i class="fa fa-plus"></i> </a>
							</div>
						</div>
					</div>
					...
					<script type="text/javascript" language="javascript" >
						$(document).ready(function(){
							$('#tbl').dataTable({
								...
								"ajax" : {
									type:"POST",
									url: "<?php echo site_url('admin/Master/json_barang')?>",
									cache: false
								},
								"aoColumns": [
