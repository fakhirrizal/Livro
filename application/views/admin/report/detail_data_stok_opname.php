			...
			<div class="portlet light ">
				<div class="portlet-body">
					...
					<div class='row'>
						<div class="col-md-12" >
							<div class="tabbable-line">
								<!-- <div class="table-toolbar">
									<div class="row">
										<div class="col-md-6">
											<a href="<?php echo site_url('admin_side/tambah_laporan_opname_1'); ?>" class="btn green uppercase">Tambah Data Laporan <i class="fa fa-plus"></i> </a>
										</div>
									</div>
								</div> -->
								<table class="table table-striped table-bordered" id="tbl1">
									...
									<tbody>
										...
										foreach ($data_detail_laporan as $key => $value) {
											...
											if($st=='0'){
												$btn_del = '<a onclick="'.$return_on_click.'" class="btn btn-xs red" href="'.site_url('admin_side/hapus_data_stok_opname_barang/'.md5($value->id_stok_opname_detail)).'">
						...
						<div class="col-md-12" >
						<hr><a href="<?php echo base_url()."admin_side/laporan_opname"; ?>" class="btn btn-info" role="button"><i class="fa fa-angle-double-left"></i> Kembali</a></div>
					</div>
				</div>
			</div>
		</div>
