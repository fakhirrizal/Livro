...
<div class="page-content-inner">
	<div class="m-heading-1 border-yellow m-bordered" style="background-color:#FAD405;">
		<h3>Catatan</h3>
		<p> 1. Jika menghapus data laporan stok opname maka stok di master barang akan bertambah (yang berstatus <b>Approved</b>).</p>
	</div>
	<div class="row">
		<div class="col-md-12">
						...
						<div class="row">
							<div class="col-md-8">
								<div class="btn-group">
									...
									<a href="<?=base_url('admin_side/tambah_laporan_opname_1');?>" class="btn green uppercase">Tambah Data <i class="fa fa-plus"></i> </a>
							</div>
						</div>
					</div>
					...
					<script type="text/javascript" language="javascript" >
						$(document).ready(function(){
							$('#tbl').dataTable({
								...
								"ajax" : {
									type:"POST",
									url: "<?php echo site_url('admin/Report/json_stok_opname')?>",
									cache: false
								},
								"aoColumns": [
