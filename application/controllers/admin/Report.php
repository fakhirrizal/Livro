...
class Report extends CI_Controller {
    ...
    public function laporan_infus()
    {
        ...
        $this->load->view('admin/report/laporan_infus',$data);
    ...
    public function json_stok_infus()
    {
        ...
        foreach ($get_data as $key => $value) {
            ...
            if($value->status=='1'){
                ...
                $href_ubah_data = 'href="'.site_url('admin_side/ubah_data_stok_infus/'.md5($value->id_stok_infus)).'"';
            }
            ...
            $isi['action'] =	'
                                <div class="btn-group" style="text-align: center;">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li>
                                            <a href="'.site_url('admin_side/detail_data_stok_infus/'.md5($value->id_stok_infus)).'">
                                                <i class="icon-eye"></i> Detil Data </a>
                                        </li>
                                        <li>
                                            <a onclick="'.$return_on_click.'" href="'.site_url('admin_side/hapus_data_stok_infus/'.md5($value->id_stok_infus)).'">
    ...
    public function tambah_laporan_infus_1()
    {
        ...
        $this->load->view('admin/template/header',$data);
        $this->load->view('admin/report/tambah_laporan_infus_1',$data);
        $this->load->view('admin/template/footer');
    }
    public function tambah_laporan_infus_2()
    {
        ...
        $this->load->view('admin/template/header',$data);
        $this->load->view('admin/report/tambah_laporan_infus_2',$data);
        $this->load->view('admin/template/footer');
    }
    public function tambah_barang_infus()
    {
        ...
        if($this->db->trans_status() === false){
            ...
            echo "<script>window.location='".base_url()."admin_side/tambah_laporan_infus_1/'</script>";
        }
        else{
    ...
    public function simpan_data_laporan_infus()
    {
        ...
        $data_insert1a = array(
            ...
            'created_at' => $this->input->post('created_at').' 00:00:00',
        ...
        $this->cart->destroy();
        $this->Main_model->log_activity($this->input->post('created_by'),'Adding data',"Menambahkan stok infus",$this->session->userdata('location'));
        $this->db->trans_complete();
        if($this->db->trans_status() === false){
            $this->session->set_flashdata('gagal','<div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Oops! </strong>data gagal ditambahkan.<br /></div>' );
    ...
    public function simpan_laporan_stok_infus_barang()
    {
        ...
        if($this->db->trans_status() === false){
            ...
            $this->session->set_flashdata('sukses','<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Yeah! </strong>data telah berhasil ditambahkan.<br /></div>' );
            echo "<script>window.location='".base_url()."admin_side/detail_data_stok_infus/".md5($this->input->post('id_stok_infus'))."'</script>";
        }
    }
    public function detail_data_stok_infus()
    {
        ...
        $this->load->view('admin/template/header',$data);
        $this->load->view('admin/report/detail_data_stok_infus',$data);
        $this->load->view('admin/template/footer');
    }
    public function daftar_barang_stok_infus()
    {
        ...
        $this->load->view('admin/template/header',$data);
        $this->load->view('admin/report/daftar_barang_stok_infus',$data);
        $this->load->view('admin/template/footer');
    }
    public function ubah_data_stok_infus()
    {
        ...
        $this->load->view('admin/template/header',$data);
        $this->load->view('admin/report/ubah_data_stok_infus',$data);
        $this->load->view('admin/template/footer');
    }
    public function perbarui_data_stok_infus()
    {
        ...
        $data_insert1 = array(
            ...
            'created_at' => $this->input->post('tgl').' '.$this->input->post('jam'),
        ...
        if($this->db->trans_status() === false){
            ...
            echo "<script>window.location='".base_url()."admin_side/ubah_data_stok_infus/".$this->input->post('id')."'</script>";
        }
        else{
    ...
    public function perbarui_status_data_stok_infus()
    {
        if($this->input->post('stts')=='9'){
            ...
            if($this->db->trans_status() === false){
                $this->session->set_flashdata('gagal','<div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Oops! </strong>data gagal diperbarui.<br /></div>' );
                echo "<script>window.location='".base_url()."admin_side/detail_data_stok_infus/".$this->input->post('id')."'</script>";
            }
            else{
                $this->session->set_flashdata('sukses','<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Yeah! </strong>data telah berhasil diperbarui.<br /></div>' );
                echo "<script>window.location='".base_url()."admin_side/detail_data_stok_infus/".$this->input->post('id')."'</script>";
            ...
            if($this->input->post('role')=='2'){
                ...
                // print_r($data_insert1);
                $this->Main_model->updateData('stok_infus',$data_insert1,array('md5(id_stok_infus)'=>$this->input->post('id')));
                echo "<script>window.location='".base_url()."admin_side/daftar_barang_stok_infus/".$this->input->post('id')."'</script>";
            }
        }
    }
    public function download_rekap_infus_barang()
    {
        if($this->input->post('optionsRadios')=='option1'){
            if($this->input->post('d1')==NULL){
                ...
                $this->load->view('admin/report/rekap_infus_barang',$data);
            }
        }else{
    ...
    public function hapus_data_stok_infus_barang()
    {
        ...
        if($this->db->trans_status() === false){
            $this->session->set_flashdata('gagal','<div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Oops! </strong>data gagal dihapus.<br /></div>' );
            echo "<script>window.location='".base_url()."admin_side/detail_data_stok_infus/".md5($id)."'</script>";
        }
        else{
            $this->session->set_flashdata('sukses','<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Yeah! </strong>data telah berhasil dihapus.<br /></div>' );
            echo "<script>window.location='".base_url()."admin_side/detail_data_stok_infus/".md5($id)."'</script>";
    ...
    {
        $this->db->trans_start();
        $get_status = $this->Main_model->getSelectedData('stok_infus a', 'a.*', array('md5(a.id_stok_infus)'=>$this->uri->segment(3)))->row();
    ...
    public function laporan_opname()
    {
        ...
        $data['grand_child'] = '';
        $this->load->view('admin/template/header',$data);
        $this->load->view('admin/report/laporan_opname',$data);
        $this->load->view('admin/template/footer');
    }
    public function json_stok_opname()
    {
        ...
        foreach ($get_data as $key => $value) {
            ...
            if($value->status=='1'){
                ...
                $isi['status'] = '<span class="label label-warning"> Pending </span>';
                $href_ubah_data = 'href="'.site_url('admin_side/ubah_data_stok_opname/'.md5($value->id_stok_opname)).'"';
            }
            $return_on_click = "return confirm('Anda yakin?')";
            $isi['action'] =	'
                                <div class="btn-group" style="text-align: center;">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li>
                                            <a href="'.site_url('admin_side/detail_data_stok_opname/'.md5($value->id_stok_opname)).'">
                                                <i class="icon-eye"></i> Detil Data </a>
                                        </li>
                                        <li>
                                            <a '.$href_ubah_data.'>
                                        ...
                                        <li>
                                            <a onclick="'.$return_on_click.'" href="'.site_url('admin_side/hapus_data_stok_opname/'.md5($value->id_stok_opname)).'">
                                                <i class="icon-trash"></i> Hapus Data </a>
                                        </li>
                                    </ul>
                                </div>
    ...
    public function tambah_laporan_opname_1()
    {
        ...
        $data['barang'] = $this->Main_model->getSelectedData('barang a', 'a.*', array('a.deleted'=>'0'))->result();
        $this->load->view('admin/template/header',$data);
        $this->load->view('admin/report/tambah_laporan_opname_1',$data);
        $this->load->view('admin/template/footer');
    }
    public function tambah_laporan_opname_2()
    {
        ...
        $this->load->view('admin/template/header',$data);
        $this->load->view('admin/report/tambah_laporan_opname_2',$data);
        $this->load->view('admin/template/footer');
    }
    public function tambah_barang_opname()
    {
        ...
        if($datacart==NULL){
            if($product['stok']<$this->input->post('qty')){
                ...
                echo "<script>window.location='".base_url()."admin_side/tambah_laporan_opname_1/'</script>";
            }else{
                $data = array(
                    'id' => $this->input->post('id_barang'),
                    'qty' => $this->input->post('qty'),
    ...
    public function simpan_data_laporan_opname()
    {
        ...
        $this->cart->destroy();
        $this->Main_model->log_activity($this->input->post('created_by'),'Adding data',"Menambahkan stok opname",$this->session->userdata('location'));
        $this->db->trans_complete();
        if($this->db->trans_status() === false){
            $this->session->set_flashdata('gagal','<div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Oops! </strong>data gagal ditambahkan.<br /></div>' );
            echo "<script>window.location='".base_url()."admin_side/laporan_opname/'</script>";
        }
        else{
            $this->session->set_flashdata('sukses','<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Yeah! </strong>data telah berhasil ditambahkan.<br /></div>' );
            echo "<script>window.location='".base_url()."admin_side/laporan_opname/'</script>";
    ...
    public function detail_data_stok_opname()
    {
        ...
        $this->load->view('admin/template/header',$data);
        $this->load->view('admin/report/detail_data_stok_opname',$data);
        $this->load->view('admin/template/footer');
    }
    public function ubah_data_stok_opname()
    {
        ...
        $this->load->view('admin/template/header',$data);
        $this->load->view('admin/report/ubah_data_stok_opname',$data);
        $this->load->view('admin/template/footer');
    }
    public function perbarui_data_stok_opname()
    {
        ...
        if($this->db->trans_status() === false){
            $this->session->set_flashdata('gagal','<div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Oops! </strong>data gagal diperbarui.<br /></div>' );
            echo "<script>window.location='".base_url()."admin_side/ubah_data_stok_opname/".$this->input->post('id')."'</script>";
        }
        else{
            $this->session->set_flashdata('sukses','<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Yeah! </strong>data telah berhasil diperbarui.<br /></div>' );
            echo "<script>window.location='".base_url()."admin_side/laporan_opname/'</script>";
    ...
    public function perbarui_status_data_stok_opname()
    {
        ...
        if($this->db->trans_status() === false){
            $this->session->set_flashdata('gagal','<div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Oops! </strong>data gagal diperbarui.<br /></div>' );
            echo "<script>window.location='".base_url()."admin_side/detail_data_stok_opname/".$this->input->post('id')."'</script>";
        }
        else{
            $this->session->set_flashdata('sukses','<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Yeah! </strong>data telah berhasil diperbarui.<br /></div>' );
            echo "<script>window.location='".base_url()."admin_side/detail_data_stok_opname/".$this->input->post('id')."'</script>";
    ...
    public function hapus_data_stok_opname_barang()
    {
        ...
        if($this->db->trans_status() === false){
            $this->session->set_flashdata('gagal','<div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Oops! </strong>data gagal dihapus.<br /></div>' );
            echo "<script>window.location='".base_url()."admin_side/detail_data_stok_opname/".md5($id)."'</script>";
        }
        else{
            $this->session->set_flashdata('sukses','<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Yeah! </strong>data telah berhasil dihapus.<br /></div>' );
            echo "<script>window.location='".base_url()."admin_side/detail_data_stok_opname/".md5($id)."'</script>";
    ...
    public function ajax_function()
    {
        if($this->input->post('modul')=='modul_ubah_data_status_laporan_stok_infus'){
            $data = $this->Main_model->getSelectedData('stok_infus a', 'a.*,b.fullname,bb.role_id', array('md5(a.id_stok_infus)'=>$this->input->post('id')), '', '', '', '', array(
                array(
                    'table' => 'user_profile b',
                    'on' => 'a.created_by=b.user_id',
                    'pos' => 'LEFT'
                ...
                array(
                    'table' => 'user_to_role bb',
                    'on' => 'a.created_by=bb.user_id',
                    'pos' => 'LEFT'
                )
            ))->row();
            ...
            $row_ket = '';
            if($data->role_id=='2'){
                $row_ket = '<input type="text" name="ket" class="form-control" value="'.$data->keterangan.'" readonly>';
            }else{
                $row_ket = '<input type="text" name="ket" class="form-control" value="'.$data->keterangan.'">';
            }
            echo'
            <form role="form" class="form-horizontal" action="'.base_url('admin_side/perbarui_status_data_stok_infus').'" method="post">
            ...
            $pecah_tanggal = explode(' ',$data->created_at);
            echo'
            <form role="form" class="form-horizontal" action="'.base_url('admin_side/perbarui_status_data_stok_opname').'" method="post">
                <input type="hidden" name="'.$this->security->get_csrf_token_name().'" value="'.$this->security->get_csrf_hash().'">
