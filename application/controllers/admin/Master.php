...
class Master extends CI_Controller {
	...
	public function karyawan_data()
	{
		...
		$this->load->view('admin/master/karyawan_data',$data);
		$this->load->view('admin/template/footer');
	}
	public function json_karyawan()
	{
		$get_data = $this->Main_model->getSelectedData('karyawan a', 'a.*,b.fullname,c.is_active,ccc.name', '', '', '', '', '', array(
			array(
			...
			$isi['action'] =	'
								<div class="btn-group" style="text-align: center;">
									...
									<ul class="dropdown-menu" role="menu">
										<li>
											<a href="'.site_url('admin_side/ubah_data_karyawan/'.md5($value->user_id)).'">
												<i class="icon-wrench"></i> Ubah Data </a>
										</li>
										<li>
											<a onclick="'.$return_on_click.'" href="'.site_url('admin_side/hapus_data_karyawan/'.md5($value->user_id)).'">
												<i class="icon-trash"></i> Hapus Data </a>
										</li>
										<li class="divider"> </li>
										<li>
											<a href="'.site_url('admin_side/atur_ulang_kata_sandi_karyawan/'.md5($value->user_id)).'">
												<i class="fa fa-refresh"></i> Atur Ulang Sandi
											</a>
										</li>
										<li>
											<a href="'.site_url('admin_side/non_aktifkan_akun_karyawan/'.md5($value->user_id)).'">
	...
	public function add_karyawan_data()
	{
		...
		$data['grand_child'] = '';
		$this->load->view('admin/template/header',$data);
		$this->load->view('admin/master/add_karyawan_data',$data);
		$this->load->view('admin/template/footer');
	}
	public function save_karyawan_data()
	{
		...
		if($cek_==NULL){
			...
			if($this->db->trans_status() === false){
				...
				echo "<script>window.location='".base_url()."admin_side/tambah_data_karyawan/'</script>";
			}
			else{
				...
				echo "<script>window.location='".base_url()."admin_side/karyawan/'</script>";
			}
		}else{
	...
	public function detail_karyawan_data()
	{
		...
		$data['grand_child'] = '';
		$this->load->view('admin/template/header',$data);
		$this->load->view('admin/master/detail_karyawan_data',$data);
		$this->load->view('admin/template/footer');
	}
	public function edit_karyawan_data()
	{
		...
		$this->load->view('admin/template/header',$data);
		$this->load->view('admin/master/edit_karyawan_data',$data);
		$this->load->view('admin/template/footer');
	}
		...
		if($this->input->post('un')!=NULL){
			...
			if($cek_==NULL){
				...
				if($this->db->trans_status() === false){
					...
					echo "<script>window.location='".base_url()."admin_side/ubah_data_karyawan/".$this->input->post('user_id')."'</script>";
				}
				else{
	...
	public function barang_data()
	{
		...
		$data['grand_child'] = '';
		$this->load->view('admin/template/header',$data);
		$this->load->view('admin/master/barang_data',$data);
		$this->load->view('admin/template/footer');
	}
		...
		foreach ($get_data as $key => $value) {
			...
			$isi['action'] =	'
								<div class="btn-group" style="text-align: center;">
									...
									<ul class="dropdown-menu" role="menu">
										<li>
											<a href="'.site_url('admin_side/ubah_data_barang/'.md5($value->id_barang)).'">
												<i class="icon-wrench"></i> Ubah Data </a>
										</li>
										<li>
											<a onclick="'.$return_on_click.'" href="'.site_url('admin_side/hapus_data_barang/'.md5($value->id_barang)).'">
												<i class="icon-trash"></i> Hapus Data </a>
										</li>
									</ul>
								</div>
	...
	public function add_barang_data()
	{
		...
		$data['grand_child'] = '';
		$this->load->view('admin/template/header',$data);
		$this->load->view('admin/master/add_barang_data',$data);
		$this->load->view('admin/template/footer');
	}
	public function save_barang_data(){
		...
		if($this->db->trans_status() === false){
			$this->session->set_flashdata('gagal','<div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Oops! </strong>data gagal ditambahkan.<br /></div>' );
			echo "<script>window.location='".base_url()."admin_side/tambah_data_barang/'</script>";
		}
		else{
			$this->session->set_flashdata('sukses','<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Yeah! </strong>data telah berhasil ditambahkan.<br /></div>' );
			echo "<script>window.location='".base_url()."admin_side/barang/'</script>";
		}
	}
	public function detail_barang_data()
	{
		...
		$this->load->view('admin/template/header',$data);
		$this->load->view('admin/master/detail_barang_data',$data);
		$this->load->view('admin/template/footer');
	}
	public function edit_barang_data()
	{
		...
		$this->load->view('admin/template/header',$data);
		$this->load->view('admin/master/edit_barang_data',$data);
		$this->load->view('admin/template/footer');
	}
	public function update_barang_data(){
		...
		if($this->db->trans_status() === false){
			$this->session->set_flashdata('gagal','<div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Oops! </strong>data gagal diubah.<br /></div>' );
			echo "<script>window.location='".base_url()."admin_side/ubah_data_barang/".$this->input->post('id_barang')."'</script>";
		}
		else{
			$this->session->set_flashdata('sukses','<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Yeah! </strong>data telah berhasil diubah.<br /></div>' );
			echo "<script>window.location='".base_url()."admin_side/barang/'</script>";
	...
	public function download_barang_data()
	{
		...
		$this->load->view('admin/master/cetak_data_barang',$data);
	}
		...
		if($cek==NULL){
			...
			if($cek_nik==NULL){
				...
				if($cek_bdt==NULL){
					...
					if($this->db->trans_status() === false){
						$this->session->set_flashdata('gagal','<div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Oops! </strong>data gagal ditambahkan.<br /></div>' );
						echo "<script>window.location='".base_url()."admin_side/detil_data_barang/".md5($this->input->post('id_barang'))."'</script>";
					}
					else{
						$this->session->set_flashdata('sukses','<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Yeah! </strong>data telah berhasil ditambahkan.<br /></div>' );
						echo "<script>window.location='".base_url()."admin_side/detil_data_barang/".md5($this->input->post('id_barang'))."'</script>";
	...
	public function update_barang_member(){
		...
		if($this->db->trans_status() === false){
			$this->session->set_flashdata('gagal','<div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Oops! </strong>data gagal diubah.<br /></div>' );
			echo "<script>window.location='".base_url()."admin_side/detil_data_barang/".$this->input->post('id_barang')."'</script>";
		}
		else{
			$this->session->set_flashdata('sukses','<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Yeah! </strong>data telah berhasil diubah.<br /></div>' );
			echo "<script>window.location='".base_url()."admin_side/detil_data_barang/".$this->input->post('id_barang')."'</script>";
			...
			$isi['action'] =	'
								<div class="btn-group">
									...
									<ul class="dropdown-menu" role="menu">
										...
										<li>
											<a onclick="'.$return_on_click.'" href="'.site_url('admin_side/hapus_data_anggota_barang/'.md5($value->id_anggota_barang)).'">
												<i class="icon-trash"></i> Hapus Data </a>
										</li>
										<li class="divider"> </li>
										<li>
											<a href="'.site_url('admin_side/atur_ulang_kata_sandi_anggota_barang/'.md5($value->id_anggota_barang)).'">
												<i class="fa fa-refresh"></i> Atur Ulang Sandi
											</a>
										</li>
									</ul>
	...
	public function reset_password_barang_member_account(){
		...
		if($this->db->trans_status() === false){
			$this->session->set_flashdata('gagal','<div class="alert alert-warning"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Oops! </strong>data gagal diubah.<br /></div>' );
			echo "<script>window.location='".base_url()."admin_side/detil_data_barang/".$id_barang."'</script>";
		}
		else{
			$this->session->set_flashdata('sukses','<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button><strong></i>Yeah! </strong>data telah berhasil diubah.<br /></div>' );
			echo "<script>window.location='".base_url()."admin_side/detil_data_barang/".$id_barang."'</script>";
	...
	public function ajax_function(){
		...
		elseif($this->input->post('modul')=='modul_ubah_data_anggota_barang'){
			...
			echo'
			<form role="form" class="form-horizontal" action="'.base_url('admin_side/perbarui_data_anggota_barang').'" method="post" >
